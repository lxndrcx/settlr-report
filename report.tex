...
\declaretheorem[numberwithin=subsection,thmbox=L,name=Theorem]{thm}
\declaretheorem[sibling=thm,thmbox=M,name=Lemma]{lem}
\declaretheorem[sibling=thm,thmbox=M,name=Corollary]{corl}
\declaretheorem[sibling=thm,thmbox=M,style=definition,name=Definition]{defn}
\declaretheorem[sibling=thm,thmbox=M,style=remark,name=Notation]{notn}
\declaretheorem[sibling=thm,thmbox=M,style=remark,name=Remark]{remk}
% \declaretheorem[sibling=thm,thmbox=M,style=remark,name=Example]{eg}
